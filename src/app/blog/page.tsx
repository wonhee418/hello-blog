          ...
          <div className="flex flex-col items-center flex-3 gap-10">
            ...
            <div className="flex gap-2 items-center justify-between self-start ">
              <div className=" flex rounded-2xl p-2 gap-2">
                ...
                <span className=" rounded-md border py-2 px-4 cursor-not-allowed">New Feed</span>
                <span className=" rounded-md border p-2 px-4 cursor-not-allowed">Favorite</span>
                <span className=" rounded-md border p-2 px-4 cursor-not-allowed">Popular</span>
              </div>
            </div>
